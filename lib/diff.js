...
import {AMBIGUOUS, DEEP_EQUAL, UNEQUAL, SHALLOW_EQUAL} from './constants.js';
...
export function diffDescriptors(lhs, rhs, options) {
		...
		if (compareResult !== DEEP_EQUAL && !firstPassSymbolProperty && typeof lhs.prepareDiff === 'function') {
			...
			if (instructions !== null) {
				...
				if (instructions.mustRecurse === true) {
					...
					// eslint-disable-next-line no-lonely-if, unicorn/prefer-switch
...
export function diff(actual, expected, options) {
