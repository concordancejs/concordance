...
// Classes to aid interactive debugging.
class ListRecursor extends recursorUtils.Recursor {}
class PropertyRecursor extends recursorUtils.Recursor {}
class IterableRecursor extends recursorUtils.Recursor {}
...
function DescribedMixin (base) {
  return class extends base {
    ...
    createPropertyRecursor () {
      ...
      return new PropertyRecursor(size, next)
    }
    ...
    createListRecursor () {
      ...
      return new ListRecursor(size, next)
    }
    ...
    createIterableRecursor () {
      ...
      return new IterableRecursor(size, next)
    }
