...
class StringValue {
  ...
  formatDiff (theme, expected, indent) {
    ...
    const actualLines = gatherLines(escapeQuotes(theme.string.multiline, escapedActual), indent)
    const expectedLines = gatherLines(escapeQuotes(theme.string.multiline, escapedExpected), indent)
