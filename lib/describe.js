...
function describeComplex (value, registry, describeItem, describeMapEntry, describeProperty) {
  ...
  const klass = SpecializedComplexes.get(stringTag) || Complex
  return klass.fromValue(value, stringTag, ctor, unwrapped, pointer, describeItem, describeMapEntry, describeProperty)
}
