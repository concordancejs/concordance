...
function describeComplex (value, registry, describeItem, describeProperty) {
  ...
  return klass.fromValue(value, tag, ctor, unwrapped, pointer, describeItem, describeProperty)
}
...
function describe (value) {
  ...
  const curriedComplex = c => describeComplex(c, registry, describeItem, describeProperty) // eslint-disable-line no-use-before-define
