...
function deserialize (buffer, options) {
  ...
  const descriptor = deserializeRecord(decoded.rootRecord, getDescriptorDeserializer, buffer)
  if (options && options.greedy && typeof descriptor.createRecursor === 'function') {
    recursorUtils.consumeDeep(descriptor.createRecursor())
  }
  return descriptor
}
