...
function decodeValue (buffer, byteOffset) {
  ...
  switch (type) {
    case valueTypes.zero: return { byteOffset, value: 0 }
    case valueTypes.negativeZero: return { byteOffset, value: -0 }
    case valueTypes.notANumber: return { byteOffset, value: NaN }
    case valueTypes.infinity: return { byteOffset, value: Infinity }
    case valueTypes.negativeInfinity: return { byteOffset, value: -Infinity }
    case valueTypes.undefined: return { byteOffset, value: undefined }
    case valueTypes.null: return { byteOffset, value: null }
    case valueTypes.true: return { byteOffset, value: true }
    case valueTypes.false: return { byteOffset, value: false }
    case valueTypes.int8:
    case valueTypes.int16:
    case valueTypes.int24:
    case valueTypes.int32:
    case valueTypes.int40:
    case valueTypes.int48: {
      const value = buffer.readIntLE(byteOffset, type)
      byteOffset += type
      return { byteOffset, value }
    }
    case valueTypes.numberString:
    case valueTypes.utf8:
