...
## formats functions with enumerable name properties

> without additional properties

    '%function.stringTag.open%Function%function.stringTag.close% %function.name.open%onlyName%function.name.close% %object.openBracket#{%%object.closeBracket#}%'

> with additional properties

    `%function.stringTag.open%Function%function.stringTag.close% %function.name.open%withExtra%function.name.close% %object.openBracket#{%␊
      bar%property.separator#: %%string.line.open#'%%string.open%baz%string.close%%string.line.close#'%%property.after#,%␊
    %object.closeBracket#}%`
