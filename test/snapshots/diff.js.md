...
> Snapshot 2
    ...
    %diffGutters.expected#+ %%string.line.open#'%%string.diff.insertLine.open%baz%string.diff.insertLine.close%%string.line.close#'%`

> Snapshot 3

    `%diffGutters.actual#- %%string.line.open#'%%string.diff.equal.open%prefix %string.diff.equal.close%%string.diff.delete.open%foo%string.diff.delete.close%%string.diff.equal.open% suffix%string.diff.equal.close%%string.line.close#'%␊
    %diffGutters.expected#+ %%string.line.open#'%%string.diff.equal.open%prefix %string.diff.equal.close%%string.diff.insert.open%bar%string.diff.insert.close%%string.diff.equal.open% suffix%string.diff.equal.close%%string.line.close#'%`
...
> Snapshot 2
    ...
    %diffGutters.actual#- %%string.diff.deleteLine.open%bar%string.diff.deleteLine.close%%string.multiline.end#\`%␊
...
> Snapshot 8
    ...
    `%diffGutters.actual#- %%string.multiline.start#\`%%string.diff.deleteLine.open%foo%string.controlPicture.open%␊%string.controlPicture.close%%string.diff.deleteLine.close%␊
    %diffGutters.actual#- %%string.diff.deleteLine.open%bar%string.controlPicture.open%␊%string.controlPicture.close%%string.diff.deleteLine.close%␊
    %diffGutters.expected#+ %%string.multiline.start#\`%%string.diff.insertLine.open%corge%string.controlPicture.open%␊%string.controlPicture.close%%string.diff.insertLine.close%␊
    %diffGutters.expected#+ %%string.diff.insertLine.open%grault%string.controlPicture.open%␊%string.controlPicture.close%%string.diff.insertLine.close%␊
...
> Snapshot 10
    ...
    `%diffGutters.padding#  %%string.multiline.start#\`%%string.diff.equal.open%foo%string.diff.equal.close%%string.controlPicture.open%␊%string.controlPicture.close%%string.diff.equal.open%%string.diff.equal.close%␊
    %diffGutters.actual#- %%string.diff.equal.open%bar-%string.diff.equal.close%%string.diff.delete.open%1%string.diff.delete.close%%string.diff.equal.open%%string.diff.equal.close%%string.controlPicture.open%␊%string.controlPicture.close%%string.diff.equal.open%%string.diff.equal.close%␊
    %diffGutters.actual#- %%string.diff.equal.open%prefix %string.diff.equal.close%%string.diff.delete.open%qux%string.diff.delete.close%%string.diff.equal.open% suffix%string.diff.equal.close%%string.controlPicture.open%␊%string.controlPicture.close%%string.diff.equal.open%%string.diff.equal.close%␊
    %diffGutters.expected#+ %%string.diff.equal.open%bar-%string.diff.equal.close%%string.diff.insert.open%2%string.diff.insert.close%%string.diff.equal.open%%string.diff.equal.close%%string.controlPicture.open%␊%string.controlPicture.close%%string.diff.equal.open%%string.diff.equal.close%␊
    %diffGutters.expected#+ %%string.diff.equal.open%prefix %string.diff.equal.close%%string.diff.insert.open%quux%string.diff.insert.close%%string.diff.equal.open% suffix%string.diff.equal.close%%string.controlPicture.open%␊%string.controlPicture.close%%string.diff.equal.open%%string.diff.equal.close%␊
    %diffGutters.padding#  %%string.diff.equal.open%%string.diff.equal.close%%string.multiline.end#\`%`
...
## detects all array item knockouts

> actual knockouts HHH vs. expect base

    `%diffGutters.padding#  %%list.openBracket#[%␊
    %diffGutters.expected#+ %  %string.line.open#'%%string.open%foo%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.expected#+ %  %string.line.open#'%%string.open%bar%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.expected#+ %  %string.line.open#'%%string.open%baz%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%qux%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%corge%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%grault%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%garply%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %%list.closeBracket#]%`

> actual base vs. expect knockouts HHH

    `%diffGutters.padding#  %%list.openBracket#[%␊
    %diffGutters.actual#- %  %string.line.open#'%%string.open%foo%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.actual#- %  %string.line.open#'%%string.open%bar%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.actual#- %  %string.line.open#'%%string.open%baz%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%qux%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%corge%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%grault%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%garply%string.close%%string.line.close#'%%item.after#,%␊
...
> actual knockouts MMM vs. expect base

    `%diffGutters.padding#  %%list.openBracket#[%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%foo%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.expected#+ %  %string.line.open#'%%string.open%bar%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.expected#+ %  %string.line.open#'%%string.open%baz%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.expected#+ %  %string.line.open#'%%string.open%qux%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%corge%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%grault%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%garply%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %%list.closeBracket#]%`

> actual base vs. expect knockouts MMM

    `%diffGutters.padding#  %%list.openBracket#[%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%foo%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.actual#- %  %string.line.open#'%%string.open%bar%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.actual#- %  %string.line.open#'%%string.open%baz%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.actual#- %  %string.line.open#'%%string.open%qux%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%corge%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%grault%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%garply%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %%list.closeBracket#]%`

> actual knockouts TTT vs. expect base

    `%diffGutters.padding#  %%list.openBracket#[%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%foo%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%bar%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%baz%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%qux%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.expected#+ %  %string.line.open#'%%string.open%corge%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.expected#+ %  %string.line.open#'%%string.open%grault%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.expected#+ %  %string.line.open#'%%string.open%garply%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %%list.closeBracket#]%`

> actual base vs. expect knockouts TTT
    ...
    %diffGutters.padding#  %  %string.line.open#'%%string.open%baz%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %  %string.line.open#'%%string.open%qux%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.actual#- %  %string.line.open#'%%string.open%corge%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.actual#- %  %string.line.open#'%%string.open%grault%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.actual#- %  %string.line.open#'%%string.open%garply%string.close%%string.line.close#'%%item.after#,%␊
    %diffGutters.padding#  %%list.closeBracket#]%`

> actual knockouts HH M vs. expect base
...
> actual base vs. expect knockouts HH M
...
> actual knockouts H MM vs. expect base
...
> actual base vs. expect knockouts H MM
...
> actual knockouts HH T vs. expect base
...
> actual base vs. expect knockouts HH T
...
> actual knockouts H TT vs. expect base
...
> actual base vs. expect knockouts H TT
...
> actual knockouts MM T vs. expect base
...
> actual base vs. expect knockouts MM T
...
> actual knockouts M TT vs. expect base
...
> actual base vs. expect knockouts M TT
...
> actual knockouts H M M vs. expect base
...
> actual base vs. expect knockouts H M M
...
> actual knockouts H M T vs. expect base
...
> actual base vs. expect knockouts H M T
...
> actual knockouts M M M vs. expect base
...
> actual base vs. expect knockouts M M M
...
> actual knockouts M M T vs. expect base
...
> actual base vs. expect knockouts M M T
...
## detects all arguments item knockouts
...
## detects all set item knockouts
...
> Snapshot 2
    ...
    `%diffGutters.actual#- %%string.line.open#'%%string.diff.equal.open%foo %string.diff.equal.close%%string.diff.equal.open%baz%string.diff.equal.close%%string.diff.delete.open% quux%string.diff.delete.close%%string.line.close#'%␊
    %diffGutters.expected#+ %%string.line.open#'%%string.diff.equal.open%foo %string.diff.equal.close%%string.diff.insert.open%bar %string.diff.insert.close%%string.diff.equal.open%baz%string.diff.equal.close%%string.line.close#'%`

> Snapshot 3

    `%diffGutters.actual#- %%string.multiline.start#\`%%string.diff.deleteLine.open%foobarbaz%string.diff.deleteLine.close%␊
...
> Snapshot 1
    ...
    %diffGutters.actual#- %  %string.diff.deleteLine.open%baz%string.controlPicture.open%␊%string.controlPicture.close%%string.diff.deleteLine.close%␊
    %diffGutters.actual#- %  %string.diff.deleteLine.open%quux%string.diff.deleteLine.close%%string.multiline.end#\`%%property.after#,%␊
    %diffGutters.expected#+ %  %string.diff.insertLine.open%bar%string.controlPicture.open%␊%string.controlPicture.close%%string.diff.insertLine.close%␊
    %diffGutters.expected#+ %  %string.diff.insertLine.open%baz%string.diff.insertLine.close%%string.multiline.end#\`%%property.after#,%␊
    %diffGutters.padding#  %%object.closeBracket#}%`
