...
## lists: render diffs with unlimited depth
...
> Snapshot 1
    ...
    %diffGutters.actual#- %    e%property.separator#: %%string.line.open#'%%string.open%g%string.close%%string.line.close#'%%property.after#,%␊
    %diffGutters.actual#- %  %object.closeBracket#}%%item.after#,%␊
    %diffGutters.padding#  %%list.closeBracket#]%`

## objects: render diffs with unlimited depth
