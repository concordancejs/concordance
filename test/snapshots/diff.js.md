...
## prioritizes words in single line string diffs

> Snapshot 1

    `%diffGutters.actual#- %%string.line.open#'%%string.diff.equal.open%The %string.diff.equal.close%%string.diff.delete.open%color%string.diff.delete.close%%string.diff.equal.open% is blue%string.diff.equal.close%%string.line.close#'%␊
    %diffGutters.expected#+ %%string.line.open#'%%string.diff.equal.open%The %string.diff.equal.close%%string.diff.insert.open%colour%string.diff.insert.close%%string.diff.equal.open% is blue%string.diff.equal.close%%string.line.close#'%`

> Snapshot 2

    `%diffGutters.actual#- %%string.line.open#'%%string.diff.equal.open%extraordinarilyLongIdentifier%string.diff.equal.close%%string.diff.delete.open%Alph%string.diff.delete.close%%string.diff.equal.open%a%string.diff.equal.close%%string.line.close#'%␊
    %diffGutters.expected#+ %%string.line.open#'%%string.diff.equal.open%extraordinarilyLongIdentifier%string.diff.equal.close%%string.diff.insert.open%Bet%string.diff.insert.close%%string.diff.equal.open%a%string.diff.equal.close%%string.line.close#'%`

> Snapshot 3

    `%diffGutters.actual#- %%string.line.open#'%%string.diff.equal.open%préférer le %string.diff.equal.close%%string.diff.delete.open%café%string.diff.delete.close%%string.diff.equal.open% chaud%string.diff.equal.close%%string.line.close#'%␊
    %diffGutters.expected#+ %%string.line.open#'%%string.diff.equal.open%préférer le %string.diff.equal.close%%string.diff.insert.open%caffè%string.diff.insert.close%%string.diff.equal.open% chaud%string.diff.equal.close%%string.line.close#'%`

> Snapshot 4

    `%diffGutters.actual#- %%string.line.open#'%%string.diff.equal.open%call(foo%string.diff.equal.close%%string.diff.delete.open%,  %string.diff.delete.close%%string.diff.equal.open%bar)%string.diff.equal.close%%string.line.close#'%␊
    %diffGutters.expected#+ %%string.line.open#'%%string.diff.equal.open%call(foo%string.diff.equal.close%%string.diff.insert.open%;	%string.diff.insert.close%%string.diff.equal.open%bar)%string.diff.equal.close%%string.line.close#'%`
