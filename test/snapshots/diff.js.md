...
> Snapshot 3
    ...
    `%diffGutters.actual#- %%string.line.open#'%%string.diff.equal.open%foo %string.diff.equal.close%%string.diff.delete.open%bar %string.diff.delete.close%%string.diff.equal.open%baz%string.diff.equal.close%%string.line.close#'%␊
    %diffGutters.expected#+ %%string.line.open#'%%string.diff.equal.open%foo %string.diff.equal.close%%string.diff.equal.open%baz%string.diff.equal.close%%string.diff.insert.open% quux%string.diff.insert.close%%string.line.close#'%`
